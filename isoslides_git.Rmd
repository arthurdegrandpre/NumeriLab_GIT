...
- Using Notebooks: R Markdown (Thanks *Lucas*), Jupyter, LiveScript (for Matlab) 
...
Stores any files and tracks *changes* occuring in them.
...
Being easily *decentralised*, it is especially effective for collaborative work. 
